...
<head>
    ...
    <link href="/admin/global/plugins/bootstrap-daterngepicker/daterangepicker-bs3.css" rel="stylesheet" type="text/css" />
    ...
    <link href="/admin/layouts/layout2/css/layout.css" rel="stylesheet" type="text/css" />
    ...
    <link href="/css/dashboard/my_layout.css" rel="stylesheet" type="text/css" />
...
<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            <a href="index.html">
                <img src="/admin/img/logo-2.png" alt="logo" class="logo-default" /> </a>
            <div class="menu-toggler sidebar-toggler hidden-lg hidden-md">
            ...
            <div class="top-menu">
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown dropdown-user">
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                            <!--<img alt="" class="img-circle" src="/admin/layouts/layout2/img/avatar3_small.jpg" />-->
                            Tester User
...
<div class="page-container">
    ...
    <div class="page-sidebar-wrapper">
        ...
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                ...
                <li class="nav-item  ">
                    <a href="my_quotes.html" class="nav-link nav-toggle">
                ...
                <li class="nav-item  ">
                    <a href="javascript:;" class="nav-link nav-toggle">
                        <span class="title">My Mechanics</span>
                    </a>
            ...
            <div class="padding-tb-10 text-center">
                <button type="button" class="btn btn-danger light btn-outline btn-lg">GET A NEW QUOTE</button>
            </div>
        </div>
        <!-- END SIDEBAR -->
    </div>
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
                        ...
                        <div class="portlet-body">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <h1 class="pull-left"><b>My Cars</b></h1>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="set-verticaly-center header-add-btn">
                                        <button type="button" class="btn btn-circle btn-default pull-right" href="#form_modal11" data-toggle="modal">+ Add a new car</button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <a href="#" class="my-portlet">
                        <div class="portlet light my-portlet">
                            <div class="portlet-body">
                                <div class="row">
                                    <div class="col-lg-4 col-md-6 col-sm-4 col-xs-12 car-info-box">
                                        <div class="text-center img-box">
                                            <img src="/admin/img/86810000_three_forth_profile.jpg">
                                        </div>
                                        <div class="text-center">
                                            <button type="button" class="btn btn-default btn-lg">View car information</button>
                                        </div>

                                        <hr class="dark hidden-lg hidden-md hidden-sm">
                                    </div>

                                    <div class="col-lg-4 col-md-6 col-sm-4 col-xs-12 services-box">
                                        <p>2013</p>
                                        <h3><b>Audi Q5</b></h3>
                                    ...
                                    <div class="col-lg-4 col-md-12 col-sm-4 col-xs-12">
                                        <hr class="dark hidden-lg hidden-sm">
                                        <div class="set-verticaly-center health-box">
                                            <div class="health-not-fond set-verticaly-center">
                                                <strong>Cars health not Found</strong>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title text-center"><b>Add a new car</b></h4>
                        </div>
                        <div class="modal-body">

                            <p class="text-center"><a href="#">Use license plate </a>or select manually below</p>
                        ...
                        <div class="modal-footer">
                            <div class="text-center">
                                <button class="btn green btn-circle btn-lg" data-dismiss="modal">Add</button>
                                <button class="btn grey-salsa btn-outline btn-circle btn-lg" data-dismiss="modal" aria-hidden="true">Cancel</button>
                            </div>
