...
<head>
    ...
    <link href="/css/angular/my_book.css" rel="stylesheet" type="text/css" />
    <link href="/css/angular/my_layout.css" rel="stylesheet" type="text/css" />
    ...
    <script src="/angular/appointment/requestManager.js"></script>
    <script src="/angular/appointment/services.js"></script>
    <script src="/angular/appointment/MyBookCtrl.js"></script>
    <script src="/angular/appointment/MyDashboardCtrl.js"></script>
    <script src="/angular/appointment/MyCarInfoCtrl.js"></script>
    <script src="/angular/appointment/QuotesListCtrl.js"></script>
    <script src="/angular/appointment/MyQuoteInfoCtrl.js"></script>
    <script src="/angular/appointment/AppointmentListCtrl.js"></script>
    <script src="/angular/appointment/AppointmentInfoCtrl.js"></script>
...
<script src="/admin/pages/scripts/components-bootstrap-switch.min.js" type="text/javascript"></script>
