...
Route::get('/auto', function () {
    return view('users.public.appointment_dashboard');
});


Route::get('/appointment_form', function () {
    return view('users.public.appointment_form');
});



Route::get('/customer_dashboard', function () {
    return view('users.public.customer_dashboard');
});
...
Route::get('/testing', function () {
    ...
    return view('users.public.testing');

});


Route::any('/auth/user-register','Auth\AuthController@AjaxRegister');

Route::any('/auth/user-login','Auth\AuthController@AjaxLogin');

Route::get('/auth/logged-user', 'Auth\AuthController@AjaxLoggedUser');
...
Route::get('/SRDashboard', function () {
    return view('admin.layouts.AngularMaster');
});
...
Route::group(['prefix' => 'customer', 'middleware' => 'isCustomer'], function() {
        ...
        Route::get('/get-info', ['as' => 'customer.get-info', 'uses' => 'WEB\CustomerDashboardController@GetCustomerInfo']);
        Route::post('/update-info', ['as' => 'customer.update-info', 'uses' => 'WEB\CustomerDashboardController@UpdateCustomerInfo']);
...
Route::group(['prefix' => '', 'middleware' => 'isCustomer'], function() {

    Route::get('/auto#/dashboard', ['as' => 'customer.update.password' ,'uses' => 'WEB\CustomerController@ChangePassword']);


    //Route::get('/auto#/dashboard', ['as' => 'customer.update.password' ,'uses' => 'WEB\CustomerController@ChangePassword']);

    http://filddy.com/auto#/dashboard
...
Route::get('/appointment/service-categories','WEB\AppointmentController@IndexServiceCategories');
Route::any('/appointment/category-services/{s_category_id}','WEB\AppointmentController@IndexCategoryServices');

Route::any('/appointment/services','WEB\AppointmentController@IndexServices');
Route::any('/appointment/services-inspection','WEB\AppointmentController@IndexInspection');

Route::any('/appointment/service-optionals/{s_id}','WEB\AppointmentController@IndexServiceOptionals');
Route::any('/appointment/service-brands/{s_id}','WEB\AppointmentController@IndexServiceBrands');

Route::any('/appointment/all-service-brands','WEB\AppointmentController@IndexAllServiceBrands');

Route::any('/appointment/service-brand-types/{s_brand_id}','WEB\AppointmentController@IndexServiceBrandTypes');


Route::any('/appointment/vehicle-brands/','WEB\AppointmentController@IndexVehicleBrands');
Route::any('/appointment/brand-years/{brand_id}','WEB\AppointmentController@IndexBrandYears');
Route::any('/appointment/vehicle-models/{brand_id}/{year_id}','WEB\AppointmentController@IndexVehicleModels');

Route::any('/appointment/price','WEB\AppointmentController@Price');
Route::any('/appointment/PriceForEachService','WEB\AppointmentController@PriceForEachService');
Route::any('/appointment/servicetime','WEB\AppointmentController@ServiceTime');

Route::any('/appointment/request-quotation','WEB\AppointmentController@RequestQuotation');

Route::any('/appointment/checkout','WEB\AppointmentController@Checkout');

//homepage icon to go to appointment form
//GetService
    Route::any('/appointment/getservice/{s_id}','WEB\AppointmentController@GetService');
...
Route::group(['prefix' => 'car'], function() {
    ...
    Route::any('/list', 'WEB\CarController@CarList');
    Route::any('/add', 'WEB\CarController@CarAdd');
    Route::any('/update-mileage', 'WEB\CarController@UpdateMileage');
    Route::any('/delete', 'WEB\CarController@CarDelete');

    // quotations


    Route::any('/quotations', 'WEB\AppointmentController@CustomerQuotations');

    Route::any('/quotation-delete', 'WEB\AppointmentController@QuotationDelete');

    Route::any('/quotation-services', 'WEB\AppointmentController@QuotationServices');

    //Appointments

    Route::any('/appointments', 'WEB\AppointmentController@CustomerAppointments');
    Route::any('/appointment-services', 'WEB\AppointmentController@AppointmentServices');
...
Route::post('/vehicles/delete/vehicles', ['as' => 'admin.vehicle.destroy_vehicles', 'uses' => 'Admin\VehicleControllerAdmin@DestroyVehicles']);
Route::delete('/vehicles/delete/{model_id}/vehicle', ['as' => 'admin.vehicle.destroy_vehicle', 'uses' => 'Admin\VehicleControllerAdmin@DestroyVehicle']);
...
Route::group(['prefix' => 'admin', 'middleware' => 'isAdmin'], function() {
    ...
    Route::get('/SRDashboard', ['as' => 'admin.SRDashboard', 'uses' => 'Admin\AdminController@RequestDashboard']);
...
//Customer Quotations
    Route::get('/customers-quotation', ['as' => 'admin.customer-quotation.index', 'uses' => 'Admin\CustomerControllerAdmin@QuotationList']);
    Route::get('/customers/{id}/edit', ['as' => 'admin.customer-quotation.edit', 'uses' => 'Admin\CustomerControllerAdmin@QuotationEdit']);
    Route::post('/customers-quotation/update', ['as' => 'admin.customer-quotation.update', 'uses' => 'Admin\CustomerControllerAdmin@QuotationUpdate']);

    Route::get('/customers-quotation/search', ['as' => 'admin.customer-quotation.search', 'uses' => 'Admin\CustomerControllerAdmin@QuotationSearch']);
...
//################   Services Management
    ...
    Route:get('/service/{id}/edit', ['as' => 'admin.service.edit', 'uses' => 'Admin\ServiceControllerAdmin@EditService']);
    ...
    Route::delete('/services/{s_id}/delete_optional/{os_id}', ['as' => 'admin.service.destroy-optional', 'uses' => 'Admin\ServiceControllerAdmin@DestroyServiceOptional']);
    //Route::get('/profile/{id}/{title}',['as'=>'mechanics.profile','uses'=>'WEB\HomeController@MechanicProfile']);
...
// Vehicles
    ...
    Route::delete('/vehicles/delete/list-of-brands/{id}', ['as' => 'admin.vehicle.lov-brand.delete', 'uses' => 'Admin\VehicleControllerAdmin@DeleteLOVBrand']);
...
Route::post('/Pricing/delete/prices', ['as' => 'admin.pricing.delete_prices', 'uses' => 'Admin\PricingControllerAdmin@DestroyPrices']);
Route::delete('/Pricing/delete/{c_s_id}/price', ['as' => 'admin.pricing.delete_price', 'uses' => 'Admin\PricingControllerAdmin@DestroyPrice']);
...
return "ss";
    ...
    Route::any('/service-brands/{s_id}','API\AppointmentControllerAPI@IndexServiceBrands');


    //Route::any('/price','API\PricingControllerAPI@Price');
    //services with brands
    Route::any('/price','API\PricingControllerAPI@PriceWithBrands');

    Route::any('/service-time','API\PricingControllerAPI@ServiceTime');


    Route::post('/checkout','API\AppointmentControllerAPI@CheckOut');

    Route::post('/CustomerAppointments','API\AppointmentControllerAPI@CustomerAppointments');

    //Route::post('/CustomerAppointments','API\CustomerDashBoardControllerAPI@CustomerAppointments');

    Route::any('/car/list', 'API\CustomerDashBoardControllerAPI@CarList');
    Route::any('/car/add', 'API\CustomerDashBoardControllerAPI@CarAdd');
    Route::any('/car/update-mileage', 'API\CustomerDashBoardControllerAPI@UpdateMileage');
    Route::any('/car/delete', 'API\CustomerDashBoardControllerAPI@CarDelete');

    // quotations

    Route::any('/car/quotations', 'API\CustomerDashBoardControllerAPI@CustomerQuotations');
    Route::any('/car/quotation-services', 'API\CustomerDashBoardControllerAPI@QuotationServices');

    //Appointments

    Route::any('/car/appointments', 'API\CustomerDashBoardControllerAPI@CustomerAppointments');
    Route::any('/car/appointment-services', 'API\CustomerDashBoardControllerAPI@AppointmentServices');
