//var app =  angular.module('formApp', ['ui.router','ui.calendar', 'ui.bootstrap','ui.bootstrap.datetimepicker'])
var app =  angular.module('formApp', ['ui.router','ui.bootstrap','ui.bootstrap.datetimepicker'],function($interpolateProvider) {
    $interpolateProvider.startSymbol('<%');
    $interpolateProvider.endSymbol('%>');
});
app.controller('SelectCarCtrl', function($scope,$state,$anchorScroll,$location,apiService,$filter,$compile,$window) {
    ...
    $scope.selectYear = function (year) {
        ...
        //if(year == "no"){
        //    obj.type = "year";
        //    obj.value = "i don't know";
        //    obj2.type = "model";
        //    obj2.value = "i don't know";
        //    obj3.type = "trim";
        //    obj3.value = "i don't know";
        //    $scope.carData.push(obj)
        //    $scope.carData.push(obj2)
        //    $scope.carData.push(obj3)
        //    $scope.showYear = false;
